...
/* we work as EIGHT_BIT_MODE , and use PORTA for data as OUTPUT */
...
/* we work on KPD , and use PORTC PINS 0 1 2 3  for ROWS AS INPUT PULLEDUP and 4 5 6 7 for col as OUTPUT high */
...
/* we use pin 0 1 for h_bridge as  OUTPUT Low */
